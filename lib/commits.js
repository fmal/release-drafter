...
const findCommitsWithAssociatedPullRequests = async ({
  ...
  const variables = {
    ...
    owner,
    targetCommitish,
    withPullRequestBody: checkIfChangeTemplateVariableShouldBeQueried(
      'BODY',
      config
    ),
    withPullRequestURL: checkIfChangeTemplateVariableShouldBeQueried(
      'URL',
      config
    ),
    withBaseRefName: checkIfChangeTemplateVariableShouldBeQueried(
      'BASE_REF_NAME',
      config
    ),
    withHeadRefName: checkIfChangeTemplateVariableShouldBeQueried(
      'HEAD_REF_NAME',
      config
    ),
    withPullRequestClosingIssues: checkIfChangeTemplateVariableShouldBeQueried(
      'CLOSING_ISSUES',
      config
    ),
